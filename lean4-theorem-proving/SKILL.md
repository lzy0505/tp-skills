...
**Note:** If there's a naming conflict with other commands, use the full form: `/lean4-theorem-proving:build-lean`
...
See `references/subagent-workflows.md` for delegation patterns.
